...
public class MainClientEX extends Thread{
	
	private final static Log log = LogFactory.getLog(MainClientEX.class); 
	...
	public void run() {
        ...
        //添加处理器
        connector.setHandler(new ClientHandlerEX());
        // 设置接收缓冲区的大小
            ...
            public void sessionClosed(NextFilter nextFilter, IoSession ioSession) throws Exception {    
                for(;;){    
                    try{    
                        ...
                        session.write("deviceId="+deviceId);  
                        ...
                        log.info("重连服务器登录失败,5秒再连接一次:" + ex.getMessage());    
	...
	public static void main(String[] args) throws Exception {  
		...
		MainClientEX mina = new MainClientEX();
        mina.start();
